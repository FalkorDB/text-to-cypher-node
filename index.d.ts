 ...
 * ```
 */
export class TextToCypher {
  /**
   * Creates a new TextToCypher client
   *
   * @param options - Client configuration including model, API key, and FalkorDB connection
   *
   * @example
   * ```javascript
   * const client = new TextToCypher({
   ...
   * @param question - Natural language question or request
   * @returns A promise that resolves to a TextToCypherResponse containing the query, result, and answer
   *
   * @example
   * ```javascript
   ...
   * @returns A promise that resolves to a TextToCypherResponse
   *
   * @example
   * ```javascript
   ...
   *
   * @param graphName - Name of the graph to generate query for
   * @param question - Natural language question or request
   * @returns A promise that resolves to a TextToCypherResponse with only the schema and query
   *
   * @example
   * ```javascript
   ...
   *
   * @param graphName - Name of the graph to discover schema for
   * @returns A promise that resolves to a JSON string representing the graph schema
   *
   * @example
   * ```javascript
